...
import { Sparkles, MoonStar, History, BarChart3, LayoutDashboard, LogIn, LogOut } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-purple-500/30">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        {!user && (
          <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-4 mb-8 text-sm text-purple-200 max-w-2xl mx-auto flex flex-col items-center text-center">
            ...
            <p className="text-purple-300/80 mb-4">
              Inicia sesión con Google para llevar un registro de tus tiradas y visualizar tus estadísticas.
            </p>
            <button 
                onClick={signInWithGoogle}
        ...
        {activeTab === 'draw' && <DrawSection user={user} />}
